...
- [x] **Step 3: Wire the update controller**
...
- [x] **Step 4: Run contract and controller tests**
...
- [x] **Step 2: Run renderer contract tests and verify RED**

Run: `npx vitest run tests/gui-auto-update-contract.test.ts`

Expected: FAIL on missing dialog and renderer behavior.

- [x] **Step 3: Implement dialog markup, behavior, styles, and translations**
...
- [x] **Step 4: Run GUI-focused tests**
...
- [x] **Step 3: Update dependency and builder configuration**
...
- [x] **Step 5: Run packaging contract tests**
...
- [x] **Step 3: Build and inspect the Linux package metadata locally**
