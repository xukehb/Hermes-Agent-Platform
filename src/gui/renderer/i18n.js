...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    'zh-CN': {
      ...
      'composer.goalModeTooltip': '切换目标驱动自主执行模式 (Goal Mode)',
      'composer.planMode': '规划模式',
      'composer.planModeTooltip': '切换规划模式 (Plan Mode)：只读规划、分步设计与验证方案',
    ...
    'en-US': {
      ...
      'composer.quickGoal': '/goal Goal Mode',
      ...
      'composer.goalModeTooltip': 'Toggle goal-driven autonomous execution mode (Goal Mode)',
      'composer.planMode': 'Plan Mode',
      'composer.planModeTooltip': 'Toggle planning mode (Plan Mode): read-only architectural planning and step-by-step verification',
